...
var frog = new Image(); frog.src = "frogger3.png";
var sx = 0;
var sy = 0;
var swidth = 40;
var sheight = 40;
...
function drawCars() {
    ...
    for (i = 0; i < carsX.length; i++) {
        ctx.drawImage(car, carsSX[i], 0, 100, 100, carsX[i], carsY[i], carWidth, carHeight);
    }
...
function moveCars() {
    if (carX1 < canvas.width + 100) {
        ...
        carX1 = -100;
        carSX1 = (Math.floor(Math.random() * 4)) * 100;
    }
    ...
    if (carX2 < canvas.width + 100) {
        ...
        carX2 = -100;
        carSX2 = (Math.floor(Math.random() * 4)) * 100;
    }
    if (carX3 > -100) {
        carX3 = carX3 - 5;
    }
        ...
        carSX3 = (Math.floor(Math.random() * 4)) * 100;
    }
    if (carX4 < canvas.width + 100) {
        ...
        carX4 = -100;
        carSX4 = (Math.floor(Math.random() * 4)) * 100;
    }
    if (carX5 > -100) {
        carX5 = carX5 + 5;
    }
        ...
        carSX5 = (Math.floor(Math.random() * 4)) * 100;
    }
    if (carX6 > -100) {
        carX6 = carX6 - 5;
    }
        ...
        carSX6 = (Math.floor(Math.random() * 4)) * 100;
    }
    if (carX7 < canvas.width + 100) {
        ...
        carX7 = -100;
        carSX7 = (Math.floor(Math.random() * 4)) * 100;
    }
    if (carX8 > -100) {
        carX8 = carX8 - 5;
    }
        ...
        carSX8 = (Math.floor(Math.random() * 4)) * 100;
    }
